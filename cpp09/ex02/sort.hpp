...
void	lst_insertion_sort (std::list <int>& list, std::list <int>& left, std::list <int>& right);
void	lst_merge (std::list <int>& list, std::list <int>& left, std::list <int>& mid, std::list <int>& right);
